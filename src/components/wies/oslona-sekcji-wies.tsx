...
const PELNA =
  "sekcja-poza-foldem wow-wejscie mt-10 scroll-mt-8 overflow-hidden rounded-2xl border border-emerald-900/10 bg-gradient-to-br from-[#f5f9f0] via-white to-sky-50/40 p-5 shadow-sm ring-1 ring-stone-900/[0.02] sm:p-6";
